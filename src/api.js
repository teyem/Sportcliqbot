...
// ─────────────────────────────────────────────────────────────────────────────
// Live scores:
//   Soccer  → football-data.org (free API key required)
//   NBA/NFL/NHL → ESPN unofficial API (no key needed)
// Fixtures/Results → TheSportsDB free (key 123)
// ─────────────────────────────────────────────────────────────────────────────
...
const footballData = axios.create({
  ...
  timeout: 30000, // increased to 20 seconds
});
...
// ── Normalise ESPN event → internal shape ─────────────────────────────────────
